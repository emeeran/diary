...
cp desktop/src-tauri/target/release/bundle/appimage/LifeLogr_0.10.1_amd64.AppImage ~/Applications/

# 2. Make it executable
chmod +x ~/Applications/LifeLogr_0.10.1_amd64.AppImage

# 3. Run it
~/Applications/LifeLogr_0.10.1_amd64.AppImage
```
...
[Desktop Entry]
Name=LifeLogr
Exec=/home/YOUR_USER/Applications/LifeLogr_0.10.1_amd64.AppImage
Icon=lifelogr
Type=Application
...
```bash
sudo dpkg -i desktop/src-tauri/target/release/bundle/deb/LifeLogr_0.10.1_amd64.deb
...
1. Double-click `LifeLogr_0.10.1_aarch64.dmg`
...
make install
make build
# Output: src-tauri/target/release/bundle/dmg/LifeLogr_0.10.1_aarch64.dmg
```
...
```bash
# Linux/macOS
DIARI_DATA_DIR=/path/to/data ./LifeLogr_0.10.1_amd64.AppImage
...
chmod +x LifeLogr_0.10.1_amd64.AppImage

# If FUSE is missing (some distros)
sudo apt install libfuse2

# Run with debug output
./LifeLogr_0.10.1_amd64.AppImage --verbose
```
